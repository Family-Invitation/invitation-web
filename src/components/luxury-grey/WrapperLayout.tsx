...
const WrapperLayout = ({ data, children }: Props) => {
  ...
  return (
    <div className="grid grid-cols-10">
      <div
        className="col-span-10 md:col-span-7  max-h-screen w-full mx-auto relative bg-cover bg-center bg-no-repeat overflow-hidden hidden md:block"
        style={{
          backgroundImage: `url('${
            windowWidth > 900
      ...
      >
        ...
        ></div>
        <div
          className={`w-full h-full relative  overflow-hidden flex flex-col items-center justify-center text-white `}
        >
          <h2
      ...
      <div className="col-span-10 md:col-span-3  h-screen overflow-y-auto">
        {children}
      </div>
    </div>
  );
