...
const section8 = ({ data }: Readonly<any>) => {
  return (
    <div className="flex justify-center items-center flex-col h-full w-full bg-[url('https://hi.momenkita.id/wp-content/uploads/2023/10/pexels-ba-tik-3754224-scaled-1.jpg')] bg-center bg-no-repeat bg-cover relative">
